...
// in der CooCox-IDE hinzugef�gt werden
//--------------------------------------------------------------
...
void UB_Font_DrawChar32(uint16_t x, uint16_t y, uint8_t ascii, UB_Font32 *font, uint32_t vg, uint32_t bg);
void UB_Font_DrawString32(uint16_t x, uint16_t y,char *ptr, UB_Font32 *font, uint32_t vg, uint32_t bg);
